...
| Gabarit de contexte agent (`AGENTS.md`/`CLAUDE.md`)       | `docs/method/CONTEXT-TEMPLATE.md` (sections et plafonds par couche, vérifiés par `ecosystem/check-context-conformance.ts`, non requis au merge pendant la vague de conformité) |
