...
| Gabarit de contexte agent (`AGENTS.md`/`CLAUDE.md`)       | `docs/method/CONTEXT-TEMPLATE.md` (sections et plafonds par couche, vérifiés par `ecosystem/check-context-conformance.ts`, requis au merge sur `governance` depuis la fin de la vague de conformité, 2026-08-19) |
| Collection de skills du harness (admission, dépréciation) | `governance/skills/` (ADR-0025 ; gouvernance d'écriture : `docs/method/SKILLS-ANATOMY.md` ; distincte de `patterns-skills`, candidat portfolio couche 2 — LEXICON §4)                                            |
